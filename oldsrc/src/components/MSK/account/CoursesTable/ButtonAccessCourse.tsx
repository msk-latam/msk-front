...
interface ButtonAccessCourseProps {
	...
	goToLMS: (product_code: number, product_code_cedente: string, email: string) => void;
	email: string;
}

const ButtonAccessCourse: FC<ButtonAccessCourseProps> = ({ item, goToEnroll, goToLMS, email }) => {
