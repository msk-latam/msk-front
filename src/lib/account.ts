...
export const productFinishOrActive = (status: string) => status.includes('Activo') || status.includes('Finalizado');
export const productStatusIsExpired = (status: string) => status.includes('Expirado');
