        ...
        <div className='md:container '>
          <div className='md:container px-4 sm:px-8 md:px-12 lg:px-20 nc-SingleContent  relative space-y-10 mb-16'>
            <div className='w-[50rem] mx-auto'>
              <p className='font-lora  text-[#392C35] pb-2 pt-4 text-xl'>
              ...
              <p className='font-lora  text-[#392C35] py-2 text-xl'>
                ...
                <Link
                  className='text-[#9200AD] underline text-xl'
                  href='/mision'
                >
                  ingresando aquí
                </Link>
              ...
              <h1 className='py-2 text-xl'> {data.title} </h1>
              <Image
                src={data.imagen}
                alt=''
                width={1000}
              ...
              />
              <h1 className='py-2 text-xl'> {data.title_convenios} </h1>
              <p className='font-lora  text-[#392C35] pb-4 text-xl'>
              ...
              <h1 className='py-2 pt-6 text-xl'>
                {' '}
                {data.title_nuestro_equipo}{' '}
              </h1>
              <p className='font-lora  text-[#392C35] pb-6 text-xl'>
                {' '}
