					...
					<div className='relative mb-16 space-y-10 nc-SingleContent'>
						<div className='w-full max-w-[50rem] mx-auto px-4 mt-5'>
							<p className='font-lora  pb-2 pt-4 text-base sm:text-lg lg:text-xl text-[#392C35]'>
								...
								y en el desarrollo de cursos de medicina.
							</p>
							<p className='font-lora  py-2 text-base sm:text-lg lg:text-xl text-[#392C35]'>
								...
								actualización a la medida de sus posibilidades. Ofrecemos una experiencia exitosa, fluida y de mejora
							...
							<h1 className='py-2 text-base sm:text-lg lg:text-xl'> {data.title} </h1>
							<Image src={data.imagen} alt='' width={1000} height={1000} className='object-cover w-full h-auto' />
							<h1 className='py-2 text-base sm:text-lg lg:text-xl'> {data.title_convenios} </h1>
							...
							<h1 className='py-2 pt-6 text-base sm:text-lg lg:text-xl'> {data.title_nuestro_equipo} </h1>
							...
							<div className='flex flex-col space-y-4'>
								...
								<h1 className='py-2 text-base sm:text-lg lg:text-xl'> {data.title_direccion_medica} </h1>
