...
const NewsletterBlog: FC<NewsletterProps> = ({ className = '' }) => {
	...
	return (
		<div className={`nc-Newsletter relative flex flex-col lg:flex-row items-center ${className}`} data-nc-id='Newsletter'>
			<div className='flex-shrink-0 mb-2 lg:mb-0 lg:mr-10 lg:w-2/5'>
				<h2 className='font-thin text-[28px] sm:text-4xl'>Disfruta nuestros contenidos</h2>
				<span className='block mt-4 text-[#6474A6]'>
					Suscríbete al newsletter y accede con anticipación a materiales académicos 100% sin costo.
				</span>
				<ul className='space-y-2 mt-6'>
					<li className='flex items-center space-x-2'>
						<Badge color='indigo' name='01' className='rounded-3xl' />
						<span className='font-medium text-neutral-700 dark:text-neutral-300'>Guías profesionales</span>
					</li>
					<li className='flex items-center space-x-2'>
						<Badge color='indigo' name='02' className='rounded-3xl' />
						<span className='font-medium text-neutral-700 dark:text-neutral-300'>Webinars</span>
					</li>
					<li className='flex items-center space-x-2'>
						<Badge color='indigo' name='03' className='rounded-3xl' />
						<span className='font-medium text-neutral-700 dark:text-neutral-300'>Infografías</span>
					</li>
				</ul>
			...
			<div className='flex-grow '>
				<div className='newsletter-doctors'>
					<NcImage src={'/images/vectors/newsletter.png'} width='1920' height='1080' alt='' />
				</div>
			</div>
			<NcModal
				isOpenProp={show}
