...
const PageContact: FC<PageContactProps> = ({ className = '' }) => {
	...
	const fullCountry = (country: string): string => {
		return countries.find((c) => c.id === country.toLowerCase())?.name || country;
	};
	...
	return (
		<div className={`nc-PageDashboard ${className} animate-fade-down`} data-nc-id='PageDashboard'>
			<LayoutPage heading='Crear cuenta' subHeading='Regístrate y disfruta al máximo de nuestra propuesta educativa'>
