...
const StoreSideBar: FC<Props> = ({ onChangeSpecialty, onChangeProfession, onChangeResource, onChangeDuration }) => {
									...
									return (
										<li key={`spe_${index}`}>
											<div className='course-sidebar-list'>
												...
												/>
												<label className='edu-check-label' htmlFor={`specialty_${specialty.name}`}>
													{specialty.name}
												</label>
											</div>
										</li>
								...
								return (
									<li key={`res_${index}`}>
										<div className='course-sidebar-list'>
											...
											/>
											<label className='edu-check-label' htmlFor={`res_${resource.id}`}>
												{resource.name}{' '}
											</label>
										</div>
									</li>
								...
								return (
									<li key={index}>
										<div className='course-sidebar-list'>
											...
											/>
											<label className='edu-check-label' htmlFor={`profession_${profession.id}`}>
												{profession.name}
											</label>
										</div>
									</li>
								...
								<li key={`dur_${index}`}>
									<div className='course-sidebar-list'>
										<input
											...
											onChange={(e) => setDurationFilter(duration, e.target.checked ? 'add' : 'delete')}
										/>
										<label className='edu-check-label' htmlFor={`dur_${duration.id}`}>
											{duration.name}
										</label>
									</div>
								</li>
