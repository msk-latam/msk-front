	...
	function getDefaultImage(title) {
		const defaultImages = {
			'Abordaje diagnóstico del dolor abdominal agudo':
				'https://wp.msklatam.com/wp-content/uploads/2021/05/imagen-secundaria-1.jpg',
			'Aféresis terapéutica en enfermedades hematológicas':
				'https://wp.msklatam.com/wp-content/uploads/2021/03/imagen-secundaria.jpg',
		};

		return defaultImages[title] || '';
	}
