...
const PageGracias: FC<PageGraciasProps> = ({ className }) => {
	...
	switch (origin) {
		...
		case 'trial':
			subHeading = '';
			message = 'Ya tienes disponible tu prueba de \n' + '7 días gratis en el curso elegido';
		...
		default:
			subHeading = 'Gracias por interesarte en <strong>Medical & Scientific Knowledge</strong>';
			message =
			...
			<LayoutPage subHeading='' heading=' '>
				<div className='thank-you-wrp'>
					...
					<div className='max-w-2xl mx-auto space-y-6'>
						...
						<ButtonPrimary onClick={() => changeRoute(route)} rounded='rounded-lg' className='font-semibold discover'>
							{buttonLabel}
						</ButtonPrimary>
					</div>
				</div>
