...
const RebillCheckout: FC<RebillCheckoutProps> = ({
		...
		if (typeof window !== 'undefined') {
			...
			if (typeof window.Rebill !== 'undefined') {
				...
				const verifiedProductAndProfile =
					typeof product !== 'undefined' && AuthState.profile != null && Object.keys(AuthState.profile).length > 1;
	...
	return (
		<>
			<div id='rebill_elements' className='flex items-center justify-center h-auto'>
