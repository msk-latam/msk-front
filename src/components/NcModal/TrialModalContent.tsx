  ...
  return (
    <div id='trial_modal' className='text-center'>
      ...
      <button
        ...
        disabled={interact}
        className='video-cart-btn w-full disabled:cursor-not-allowed disabled:bg-grey-disabled'
      >
      ...
      {cancelButton && (
        <button
          ...
          disabled={interact}
          className='video-cart-btn border-2 w-full mt-2 disabled:cursor-not-allowed disabled:hover:bg-grey-disabled disabled:bg-grey-disabled disabled:text-white disabled:border-white disabled:hover:border-white'
        >
          Cancelar
        </button>
      )}
