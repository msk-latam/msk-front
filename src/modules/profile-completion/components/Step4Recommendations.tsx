...
export default function Step4Recommendations({ onBack }: Step4RecommendationsProps) {
	...
	return (
		...
		// 	</div>
		// </Modal>
		<Modal isOpen={true} onClose={() => {}} title=' ¡Listo para avanzar!' size='large'>
			<div className='flex flex-col gap-4'>
				<div className='flex-1 overflow-y-auto px-4 sm:px-10'>
					...
					<div className='p-4 sm:py-6 text-center'>
						<Link
							href='/dashboard'
							className='bg-[#9200AD] hover:scale-105 text-white font-semibold transition h-[52px] px-6 py-4 md:mb-18   mb-9 rounded-[38px] inline-block'
						>
							Ir a mi perfil
						</Link>
					</div>
