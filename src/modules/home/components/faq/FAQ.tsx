...
// FAQ SIN INTEGRACION - Funcionando
...
{/*import React, { useState } from 'react';
import useFaqs from '@/modules/home/components/faq/hooks/useFaqs'; // Importa el hook
import { motion, AnimatePresence } from 'framer-motion';
import { ArrowDown, ArrowUp } from 'lucide-react';

const FaqSection = () => {
  const [openIndex, setOpenIndex] = useState<number | null>(0);
  const { faqData, loading, error } = useFaqs(); // Usa el hook
        ...
        <div className="rounded-[40px] max-w-7xl mx-auto px-6 md:px-12 pb-12">
          ...
          <div className="divide-y divide-neutral-200">
            ...
            <div className="py-6 text-center text-neutral-600">
              <p className="text-sm">No hay preguntas frecuentes disponibles en este momento.</p>
            </div>
          </div>
        </div>
      </section>
