...
const Institutions = () => {
  ...
  return (
    <section className="relative bg-white rounded-[40px] overflow-visible max-w-[1300px] mx-auto -mt-24 translate-y-[70px] z-10 py-10 px-5 md:px-10 md:gap-4 shadow-lg">
