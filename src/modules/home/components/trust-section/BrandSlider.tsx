...
const BrandSlider: FC<BrandSliderProps> = ({ country }) => {
  ...
  return (
    <div className="relative">
      ...
      <div
        className="flex py-4 md:pl-16 md:space-x-8 md:overflow-x-auto md:scrollbar-hide md:overscroll-none"
        ...
        onWheel={handleWheel}
      >
        <div className="grid md:flex md:flex-row grid-cols-2 gap-4">
