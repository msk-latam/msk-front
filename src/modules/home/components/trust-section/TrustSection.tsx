...
const TrustSection = () => {
  ...
  return (
    <div className="relative w-full bg-gray-100 pt-24 pb-60 h-[1200px] md:h-[750px] z-9 ">
      <section className="relative bg-white rounded-[38px] md:p-[72px] md:px-[104px] translate-y-[20px] -mt-40 mb-16 z-9 py-10 pl-5 md:overflow-visible max-w-[1400px] mx-auto shadow-lg md:min-h-[500px] md:max-h-[750px] overflow-hidden">
