...
const Oportunidades = () => {
  return (
    <div className="relative w-full bg-gray-100 pt-24 pb-32 z-0">
      <section className="relative bg-white rounded-[40px] max-w-7xl mx-auto -mt-32 mb-[-150px] z-10 py-10 shadow-lg">

  <div className="px-5 md:px-10"> {/* <-- Agregado el padding lateral */}
