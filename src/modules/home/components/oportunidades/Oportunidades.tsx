...
import OportunidadesSkeleton from "@/modules/home/skeletons/OportunidadesSkeleton"; // 👈 Importar Skeleton
...
const Oportunidades = () => {
  ...
  if (loading) {
    return <OportunidadesSkeleton />; // 👈 Mostrar Skeleton mientras carga
  }
      ...
      <div className="relative bg-white rounded-[38px] -mt-32 -mb-64 pt-6 md:pt-[72px] md:pb-16 shadow-lg">
        <div className="px-5 md:px-16 pb-6 md:mb-0">
          ...
          <header className="md:text-left text-center max-w-7xl px-6 gap-4 md:px-0">
            <h2 id="oportunidades-heading" className="mb-2 md:text-[34px] text-[20px] leading-[100%] text-[#1A1A1A] align-middle">
