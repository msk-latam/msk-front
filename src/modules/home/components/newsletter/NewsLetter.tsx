...
const Newsletter = () => {
  ...
  return (
    <div className="w-full px-4 md:px-0 flex flex-col items-center justify-center bg-[#1A1A1A] text-white font-raleway">
      {/* Newsletter superior */}
      <div className="bg-[#35383E] w-full max-w-[343px] md:max-w-screen-xl -mt-8 p-6 md:py-6 md:px-10 md:rounded-[38px] rounded-[38px] flex flex-col md:flex-row items-center justify-between gap-4 md:gap-8 mx-auto">
