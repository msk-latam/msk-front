			...
			{slides.map((src, i) => (
				...
				>
					<div
						...
						style={{
							background: `linear-gradient(180deg, rgba(0, 0, 0, 0) 33.01%, rgba(0, 0, 0, 0.4) 53.02%),
                          linear-gradient(360deg, rgba(0, 0, 0, 0) 43.69%, rgba(0, 0, 0, 0.2) 100%)`,
						}}
					/>
					<img src={src} alt={`Slide ${i + 1}`} className='absolute inset-0 object-cover w-full h-full' />
				</div>
			))}
