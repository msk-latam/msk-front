...
const HeroHighlight = () => {
  ...
  return (
    <div className="md:relative md:-bottom-[40px] md:pb-0 absolute bottom-0 w-full h-40 md:h-auto portrait:-z-10 overflow-scroll md:overflow-hidden scrollbar-track-transparent">
      <div
        ref={containerRef}
