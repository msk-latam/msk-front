...
const Masterclass = () => {
  ...
  return (
    ...
    >
      ...
      <main className="relative z-10 h-full md:h-screen overflow-visible max-w-[1300px] mx-auto w-full py-11 mt-8 md:py-0 md:mt-0 flex flex-col justify-center md:px-20 md:mb-10">
