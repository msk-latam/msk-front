  ...
  return (
    <Link
      href={
        isDemo
          ? getLocalizedUrl(
              lang,
              "/curso/administracion-y-gestion-hospitalaria/#equipo-docente"
            )
          : pro.perfilUrl || "#"
      }
      onClick={(e) => {
    ...
    >
      ...
      <div className="absolute bottom-6 w-full flex flex-col items-center gap-6 text-center text-white px-4 z-8">
        <div>
          <p className="font-lora-italic font-normal text-white text-[24px] opacity-90">
            Masterclass
          </p>
          <h1 className="text-[34px] font-bold font-raleway leading-tight mt-1">
            {pro.nombre}
          </h1>
        </div>
        ...
        {masterclassTitle && (
          <h2 className="text-lg font-raleway font-semibold text-white">
            {masterclassTitle}
          </h2>
        )}
        ...
        <h1 className="text-[14px] font-Raleway font-500 mt-2">
          {pro.duration || ""}
        </h1>
      </div>
    </Link>
