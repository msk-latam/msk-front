...
const Newsletter = () => {
  ...
  return (
    <div className="w-full px-4 md:px-20 flex flex-col items-center justify-center bg-[#1A1A1A] text-white">
      {/* Newsletter superior */}
      <div className="bg-[#35383E] w-full max-w-[343px] md:max-w-screen-xl md:-mt-14 -mt-8 p-6 md:py-6 md:px-10 md:rounded-[38px] rounded-[38px] z-10 flex flex-col md:flex-row  justify-between gap-4 md:gap-8 mx-auto">
