...
const ViewInstitutions: React.FC<Props> = ({ navigateTo, isMobile = true }) => {
        ...
        <div className="px-4 py-6">
          ...
          <div className="grid grid-cols-9 gap-2">
            <div
              ...
              style={{
                backgroundImage:
                  "url('/images/instituciones/universidades.svg')",
            ...
            >
              <div className="h-fit flex flex-col justify-between">
                ...
                <div className="z-10 text-white text-sm bg-cover">
                  Universidades
                </div>
              </div>
          ...
          <div className=" bg-[#35383e] rounded-2xl px-3">
            ...
            <div
              ...
              style={{
                backgroundImage: "url('/images/instituciones/empresas.svg')",
                backgroundSize: "cover",
                backgroundPosition: "center",
              }}
            >
            ...
            <div
              ...
              style={{
                backgroundImage: "url('/images/instituciones/alianzas.svg')",
                backgroundSize: "cover",
                backgroundPosition: "center",
              }}
            >
  ...
  // Versión mobile con imágenes
  return (
    <div className="bg-[#1e1e1e] rounded-t-3xl mt-4 h-fit">
      <div className="flex items-center px-6 py-4">
        <button className="mr-4 text-white" onClick={() => navigateTo("main")}>
          <ArrowLeft size={24} />
        </button>
      ...
      <div className="px-6 pt-2 pb-6">
        ...
        >
          <div
            ...
            style={{
              backgroundImage: "url('/images/instituciones/universidades.svg')",
              backgroundSize: "cover",
              backgroundPosition: "center",
            }}
          >
