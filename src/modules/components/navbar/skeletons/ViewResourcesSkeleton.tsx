...
const ViewResourcesSkeleton: React.FC = () => {
  return (
    <div className="pt-0 md:space-y-4 md:p-4">
      {/* ViewResourcesSkeleton loader para desktop */}
      ...
      {/* ViewResourcesSkeleton loader para mobile */}
      ...
      <div className="animate-pulse flex flex-col space-y-4 px-6 pt-20">
        ...
        {/* ViewResourcesSkeleton para las ofertas */}
...
export default ViewResourcesSkeleton;
