...
export default function CourseSummary({ slug, lang }: CourseSummaryProps) {
  ...
  return (
    <div
      className="bg-white rounded-[38px] p-6 md:p-8 sticky top-10 w-full"
    ...
    >
      ...
      {data?.total_price && Number(data.total_price) > 0 && (
        <>
          ...
          <p className="text-[#4F5D89] font-inter font-medium text-base">
            {max_installments} pagos de:
          </p>
      ...
      <ul className="text-sm text-[#4F5D89] font-inter font-medium space-y-3 mb-6">
        <li className="flex items-center gap-2">
          <img
            src="/icons/course/summary/world.svg"
            alt=""
            className="w-4 h-4"
          />
        ...
        <li className="flex items-center gap-2">
          <img
            src="/icons/course/summary/modules.svg"
            alt=""
            className="w-4 h-4"
          />
        ...
        <li className="flex items-center gap-2">
          <img
            src="/icons/course/summary/hourglass.svg"
            alt=""
            className="w-4 h-4"
          />
          {duration}
        ...
        <li className="flex items-center gap-2">
          <img
            src="/icons/course/summary/person.svg"
            alt=""
            className="w-4 h-4"
          />
        ...
        <li className="flex items-center gap-2">
          <img
            src="/icons/course/summary/download.svg"
            alt=""
            className="w-4 h-4"
          />
          {certification
      ...
      {cedente && (
        <>
          <p className="text-xs text-[#4F5D89] font-inter font-medium mb-2">
            Cedente
            <br />
            <strong className="text-[#4F5D89] font-inter font-medium">
              {cedente.name}
            </strong>
          </p>
