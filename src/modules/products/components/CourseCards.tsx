    ...
    <section className="max-w-5xl mx-auto">
      ...
      <div className="grid gap-4 md:grid-cols-3 text-center">
        {features.map((item, index) => (
          <div
            key={index}
            className="rounded-[38px] py-6 px-5 shadow-sm bg-white"
          >
            <div className="flex font-raleway text-xl font-bold md:justify-start justify-center pl-2 mb-3">{item.icon}</div>
