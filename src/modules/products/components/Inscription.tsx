...
const Inscription = () => {
	return (
		<div className='w-full px-4 md:px-12 flex flex-col items-center z-10 justify-center bg-black text-white'>
			<div className='bg-white text-black w-full -mt-8 md:-mt-14 px-6 py-9 md:py-6 md:px-10 rounded-[38px] z-[9] flex flex-col md:flex-row justify-between gap-4 md:gap-8 overflow-visible max-w-[1300px] mx-auto items-center'>
				{/* Texto principal */}
				<div className='flex flex-col md:flex-row items-center gap-2 md:gap-3 flex-wrap text-center md:text-left'>
