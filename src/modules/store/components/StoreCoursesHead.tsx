      ...
      <div className="flex flex-col md:flex-row items-center gap-4 flex-grow sm:flex-grow-0">
        ...
        <div className="relative flex-grow w-full md:max-w-xs">
          <input
            type="text"
            placeholder="Buscar"
            className="w-full pl-4 pr-10 py-2.5 border border-gray-300 rounded-full text-sm focus:outline-none focus:border-primary focus:ring-[#9200AD] focus:border-[#9200AD] focus:ring-1 focus:ring-primary"
            value={searchTerm}
