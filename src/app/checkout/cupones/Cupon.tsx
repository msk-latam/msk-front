		...
		<div className='mt-4'>
			...
			<div className='flex mt-2'>
				<input
					...
					className='border p-2 rounded-l w-full focus:ring focus:ring-blue-300'
					disabled={isLoading}
				/>
				<button
					onClick={handleApplyCoupon}
					className={`bg-blue-500 text-white px-4 rounded-r hover:bg-blue-600 transition flex items-center justify-center ${
