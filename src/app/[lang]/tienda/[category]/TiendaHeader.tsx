		...
		<div className='relative'>
			...
			<div className='relative mb-4'>
				...
				<div className=' relative py-5 '>
					<h1 className='text-[#6474A6] text-xl  !font-inter pb-2'>¿Por qué es importante la {matchedSpecialty?.name}?</h1>
					<p className='text-[#6474A6] !font-raleway '>
						Esta especialidad tiene incidencia específica en el nivel de salud de las personas, las familias y la comunidad
						en general. Si te capacitas en medicina familiar y comunitaria, te estarás preparando para resolver la mayoría de
						los problemas de salud que presenta la población y coordinar los distintos niveles de atención, permitiendo así
						el buen funcionamiento de todo el sistema hospitalario.
					</p>
				</div>
			</div>
		</div>
