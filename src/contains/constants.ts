export const IS_PROD = process.env.PROD || process.env.NODE_ENV === 'production';
...
export const API_PAYMENT_URL = IS_PROD ? 'https://payment.msklatam.net' : 'http://localhost:8000';
